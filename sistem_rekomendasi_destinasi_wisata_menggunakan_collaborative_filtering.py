# -*- coding: utf-8 -*-
"""SISTEM REKOMENDASI DESTINASI WISATA MENGGUNAKAN COLLABORATIVE FILTERING.ipynb
...
# SISTEM REKOMENDASI DESTINASI WISATA MENGGUNAKAN COLLABORATIVE FILTERING
...
# Hanya menggunakan data wisata pada kota Surabaya
place = place[place['City']=='Yogyakarta']
place.head()

# Mengubah rating agar hanya berisi rating pada kota Surabaya
# Gabungkan 2 data frame yaitu rating dan place berdasarkan kolom 'Place_Id'
rating = pd.merge(rating, place[['Place_Id']], how='right', on='Place_Id')
rating.head()

# Mengubah rating agar hanya berisi wisatawan pada kota Surabaya
